...
public class ImageLab extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        System.load("/Users/shop/Documents/OPENCV/opencv-2.4.13/build/lib/libopencv_java2413.dylib");
        
        // declaring faceDetector variable, based on the haarcascade frontalface database
        CascadeClassifier faceDetector = new CascadeClassifier(FaceDetector.class.getResource("haarcascade_frontalface_alt.xml").getPath());
        
        // converting the image to an n-dimensional dense array class that could be used for analysing (Mat class)
        // Mat image = Highgui.imread(FaceDetector.class.getResource("file").getPath());
        Mat image = Highgui.imread(cvFile.getPath());
        
        // declaring faceDetections variable as class of MatOfRect, which is a container Class of Rect
        MatOfRect faceDetections = new MatOfRect();
        
        // detecting faces in the image using detectMultiScale function
        faceDetector.detectMultiScale(image, faceDetections);
        System.out.println(String.format("Detected %s faces", faceDetections.toArray().length));
        
        // drawing a thin green rectangle around the detected face
        ...
        String filename = "outputcvfile.jpg";
        System.out.println(String.format("Writing %s", filename));
        imwrite(filename, image);
                
        ImageIcon icon = new ImageIcon("outputcvfile.jpg");
        icon.getImage().flush();
